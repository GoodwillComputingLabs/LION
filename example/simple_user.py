...
for app in top_apps:
    ...
    fig.subplots_adjust(left=0.11, bottom=0.12, right=.98, top=.95, wspace=0.1, hspace=0.55)
    fig.text(0.5, 0.80, x_axes[0], ha='center', va='bottom')
    fig.text(0.5, 0.60, x_axes[1], ha='center', va='bottom')
    fig.text(0.5, 0.40, x_axes[2], ha='center', va='bottom')
    fig.text(0.01, 0.6, 'Performance Score', ha='left', va='center', rotation=90)
